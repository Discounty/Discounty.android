...
import discounty.com.google.zxing.client.android.share.BookmarkColumns;
...
public final class BookmarkPickerActivity extends ListActivity {
  ...
  protected void onResume() {
    super.onResume();
    cursor = getContentResolver().query(BookmarkColumns.BOOKMARKS_URI, BOOKMARK_PROJECTION,
