...
import discounty.com.helpers.SQLiteUriMatcher;
import discounty.com.interfaces.SQLiteOperation;

/**
 * ContentProvider for Discounty database
 */
public class DiscountyContentProvider extends ContentProvider {
    ...
    private static final Map<String, DiscountyTableProvider> SCHEMA = new ConcurrentHashMap<>();
...
//            mHelper = new SQLiteOpenHelperImpl(getContext());
    ...
    public Cursor query(Uri uri, String[] columns, String where, String[] whereArgs, String orderBy) {
        ...
        final DiscountyTableProvider tableProvider = SCHEMA.get(tableName);
    ...
    private int updateInternal(Uri uri, DiscountyTableProvider provider,
